...
class TestClassJav {
    ...
    @BeforeAll //A getNev ne adjon hozza pizza szot!! pls work
    ...
    void pizzaKonstruktorTest() {
        ...
        Assertions.assertEquals("szalamis pizza", p3.getNev(), "Hibas a konstruktor!");
    ...
    void pizzaFelultoltosKonstruktorTest() {
        p2 = new Pizza("sajtos pizza", 1500);
    ...
    void pizzaKonstruktorNegativArTest() {
        try {
            p5 = new Pizza("sajtos pizza", 1500, -1000);
    ...
    @Test
    void pizzaGetArTest() {
        Assertions.assertEquals(2100, p3.getAr(), "Hibas a getAr metodus!");
    }
    ...
    void pizzaFeltetetFelveszTest() {
        ...
        ArrayList<Feltet> feltetek = new ArrayList<>();
    ...
    void etelToStringTest() {
        Assertions.assertEquals("tej (200.0 kalória), fogyasztható: igen.", e1.toString(),
